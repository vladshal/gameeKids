...
def prepare():
    mc.setBlocks(-100,-100,-30,100,100,100,block.AIR)
    ...
    mc.setBlocks(0,-15,0,15,-15,15,block.ICE)
    mc.setBlocks(-1,-15,16,16,-10,16,block.SNOW)
    mc.setBlocks(16,-15,-1,16,-10,16,block.SNOW)
    mc.setBlocks(-1,-15,-1,-1,-10,16,block.SNOW)
    mc.setBlocks(0,-15,-1,15,-10,-1,block.SNOW)

    mc.setBlocks(0,-25,0,15,-25,15,block.LEAVES)
    mc.setBlocks(-1,-25,16,16,-20,16,block.CACTUS)
    mc.setBlocks(16,-25,-1,16,-20,16,block.CACTUS)
    mc.setBlocks(-1,-25,-1,-1,-20,16,block.CACTUS)
    mc.setBlocks(0,-25,-1,15,-20,-1,block.CACTUS)
    ...
    mc.setBlocks(0,-20,-1,15,-15,-1,block.COAL_ORE)
